...
from api.accounts_api.data_tests import user_sign_up, user_sign_in, user_invalid
...
class TestSignUpAPIView(APITestCase):
    ...
    def setUp(self):
        self.url = reverse('accounts_api-signup')
...
class TestCustomTokenRefreshView(APITestCase):
    ...
    def setUp(self):
        ...
        self.tokens = views.SignUpAPIView.as_view()(
            self.factory.post(reverse('accounts_api-signup'), user_sign_up)
        ).data
